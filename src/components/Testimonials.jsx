  ...
  return (
      ...
      <div className="max-w-[1592px] mx-auto">
        ...
        <div className="relative flex flex-row gap-2 md:gap-[50px] justify-between items-center">
          {/* Left Arrow */}
          <button className=" hidden  md:min-w-[58px] md:min-h-[58px] bg-white border-2 border-gray-800 rounded-lg md:flex items-center justify-center hover:bg-gray-50 transition-colors">
          ...
          <div  className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-8 px-8">
            {testimonials.map((testimonial, index) => (
             ...
             <button className=" md:min-w-[58px] hidden md:min-h-[58px] bg-white border-2 border-gray-800 rounded-lg md:flex items-center justify-center hover:bg-gray-50 transition-colors">
